...
fig_ndss, ((ax0, ax1, ax2), (ax4, ax5, ax6)) = plt.subplots(2, 3, figsize=(20, 12))
...
ax0.set(title="The influence of facility accessibility on diabetes (fig1.0)",
...
scatter = ax1.scatter(
                    ...
                    y=db[factor['dndss']],
                    c=db['colour'],cmap='seismic');
ax1.set(title="The influence of sports participation on diabetes (fig1.1)",
       xlabel=factor['sport']+' (%)',
       ylabel=factor['dndss']+' (%)');
...
#                     y=db[factor['dndss']],
#                     c=db['colour'],cmap='seismic');
# ax2.set(title="The influence of physical activity on diabetes (fig1.2)",
...
# ============================================================================ #
fig_ndss.savefig("Figure1-diabetes_with_factors.png")


# ############################################################################################################# #
# Facility count influencing other factors
fig_facility, ((ax0, ax1), (ax2, ax3)) = plt.subplots(nrows=2, ncols=2, figsize=(18, 12))
...
scatter = ax0.scatter(
                    ...
                    y=db[factor['sport']],
                    c=db['colour'],cmap='seismic');
ax0.set(title="The influence of facility accessibility on sports participation in consideration of LGA status (fig2.1)",
       xlabel=factor['facility']+' (unit)',
       ylabel=factor['sport']+' (%)');
...
scatter = ax1.scatter(
                    ...
                    c=db['colour'],cmap='seismic');
ax1.set(title="The influence of facility accessibility on physical activity in consideration of LGA status (fig2.2)",
       xlabel=factor['facility']+' (unit)',
...
# ============================================================================ #
fig_facility.savefig("Figure2-facility_to_sporting_and_physical.png")
